...
CREATE TABLE nexchief.wardes_profile (
    ...
    CONSTRAINT fk_nexchief_wardes_profile_nexchief_account FOREIGN KEY (nexchief_account_id) REFERENCES nexchief.user (id),
    CONSTRAINT fk_nexchief_wardes_profile_user FOREIGN KEY (user_id) REFERENCES nexchief.user (id),
    CONSTRAINT fk_nexchief_wardes_profile_company_profile FOREIGN KEY (company_profile_id) REFERENCES nexchief.wardes_profile (id)
);
...
CREATE TABLE nexchief.wardes_profile_image (
    ...
    CONSTRAINT fk_nexchief_wardes_profile_image_nexchief_account FOREIGN KEY (nexchief_account_id) REFERENCES nexchief.user (id),
    CONSTRAINT fk_nexchief_wardes_profile_image_wardes_profile FOREIGN KEY (wardes_profile_id) REFERENCES nexchief.wardes_profile (id)
);
