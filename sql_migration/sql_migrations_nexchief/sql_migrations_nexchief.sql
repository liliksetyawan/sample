...
CREATE TABLE user (
    id BIGINT DEFAULT nextval('user_pkey_seq'::regclass) PRIMARY KEY,
...
CREATE TABLE wardes_profile (
    id BIGINT DEFAULT nextval('wardes_profile_pkey_seq'::regclass) PRIMARY KEY,
    uuid_key UUID DEFAULT public.uuid_generate_v4(),
...
CREATE TABLE person_profile (
    id BIGINT DEFAULT nextval('person_profile_pkey_seq'::regclass) PRIMARY KEY,
    uuid_key UUID DEFAULT public.uuid_generate_v4(),
    person_profile_id BIGINT,
    title_id BIGINT,
...
CREATE TABLE parameter (
    id BIGINT DEFAULT nextval('parameter_pkey_seq'::regclass) PRIMARY KEY,
    uuid_key UUID DEFAULT public.uuid_generate_v4(),
...
CREATE TABLE wardes_profile_image (
    id BIGINT DEFAULT nextval('wardes_profile_image_pkey_seq'::regclass) PRIMARY KEY,
    uuid_key UUID DEFAULT public.uuid_generate_v4(),
    nexchief_account_id BIGINT,
