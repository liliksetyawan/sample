...
type WardesProfileDTOIn struct {
   ...
   Gender    string `json:"gender" required:"insert,update" min:"1" max:"255"`
   ...
   Nik    string `json:"nik" required:"insert,update" min:"1" max:"255" regex:"nik"`
   Age    string `json:"age" required:"insert,update" min:"1" max:"255"`
   Hamlet    string `json:"hamlet" required:"insert,update" min:"1" max:"255"`
   Neighbour    string `json:"neighbour" required:"insert,update" min:"1" max:"255"`
   ...
   BuildingWidthFirstFloor    float64 `json:"building_width_first_floor" required:"insert,update" max:"999999999.99"`
   BuildingLengthFirstFloor    float64 `json:"building_length_first_floor" required:"insert,update" max:"999999999.99"`
   BuildingHeightFirstFloor    float64 `json:"building_height_first_floor" required:"insert,update" max:"999999999.99"`
   BuildingWidthSecondFloor    float64 `json:"building_width_second_floor" required:"insert,update" max:"999999999.99"`
   BuildingLengthSecondFloor    float64 `json:"building_length_second_floor" required:"insert,update" max:"999999999.99"`
   BuildingHeightSecondFloor    float64 `json:"building_height_second_floor" required:"insert,update" max:"999999999.99"`
   ParkingLotWidth    float64 `json:"parking_lot_width" required:"insert,update" max:"999999999.99"`
   ParkingLotLength    float64 `json:"parking_lot_length" required:"insert,update" max:"999999999.99"`
   ...
   ProfileCompletionStatus    string `json:"profile_completion_status" required:"insert,update" min:"1" max:"255"`
   CompanyProfileId    int64 `json:"company_profile_id" required:"insert,update" min:"1" max:"9223372036854775807"`
   Code    string `json:"code" required:"insert,update" min:"1" max:"255"`
   Schema    string `json:"schema" required:"insert,update" min:"1" max:"255"`
   Status    string `json:"status" required:"insert,update" min:"1" max:"255"`
   ...
   NewProfileApprovalStatus    string `json:"new_profile_approval_status" required:"insert,update" min:"1" max:"255"`
