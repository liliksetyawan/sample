...
// Descriptions: Insert a new wardes_profile_image record with temporary flag
func (d *wardes_profile_imagePostgresqlSQLDAO) InsertWardesProfileImageWithTemporary(
