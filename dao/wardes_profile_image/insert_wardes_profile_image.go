...
func (d *wardes_profile_imagePostgresqlSQLDAO) InsertWardesProfileImage(
    ...
    query := fmt.Sprintf(`
        INSERT INTO %s (
            nexchief_account_id, type, path_image, wardes_profile_id,
    ...
    err = stmt.QueryRow(
        dtoIn.NexchiefAccountID.Int64, dtoIn.Type.String, dtoIn.PathImage.String, dtoIn.WardesProfileID.Int64,
