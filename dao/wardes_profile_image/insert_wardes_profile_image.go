...
// Descriptions: This function will insert a new wardes_profile_image record.
func (d *wardes_profile_imagePostgresqlSQLDAO) InsertWardesProfileImage(
    ...
    query := fmt.Sprintf(`
        INSERT INTO %s (
            ...
            updated_by, updated_client, updated_at, deleted
        )
        VALUES (
            $1, $2, $3, $4,
            $5, $6, $7, 
    ...
    err = stmt.QueryRow(
        ...
        ctx.Limitation.UserID, ctx.AuthAccessTokenModel.ClientID, dtoIn.UpdatedAt.Time, dtoIn.Deleted.Bool,
