...
func (d *person_profilePostgresqlSQLDAO) InsertPersonProfile(
    ...
    query := fmt.Sprintf(`
        INSERT INTO %s (
            ...
            sex, nik, address_1, created_at, created_by, created_client, 
    ...
    err = stmt.QueryRow(
        dtoIn.PersonProfileID.Int64, dtoIn.TitleID.Int64, dtoIn.TitleName.String, dtoIn.FirstName.String, dtoIn.LastName.String,
        dtoIn.Sex.String, dtoIn.NIK.String, dtoIn.Address1.String,
